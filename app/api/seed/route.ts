...
const DEMO_PRODUCTS: Partial<Product>[] = [
  ...
  { name: 'Kitchen Organizer Box', barcode: '8901234567892', category: 'Kitchen', hsn_code: '3924', gst_rate: 12, price: 149, stock_qty: 60, low_stock_threshold: 20, is_active: true },
  { name: 'Stainless Steel Bottle', barcode: '8901234567893', category: 'Kitchen', hsn_code: '7323', gst_rate: 12, price: 149, stock_qty: 80, low_stock_threshold: 20, is_active: true },
  { name: 'Cotton T-Shirt Basic', barcode: '8901234567894', category: 'Fashion', hsn_code: '6109', gst_rate: 5, price: 149, stock_qty: 2, low_stock_threshold: 20, is_active: true },
  { name: 'Handkerchief Set (3pc)', barcode: '8901234567895', category: 'Fashion', hsn_code: '6213', gst_rate: 5, price: 149, stock_qty: 50, low_stock_threshold: 20, is_active: true },
  ...
  { name: 'Face Wash Gel 100ml', barcode: '8901234567901', category: 'Care', hsn_code: '3401', gst_rate: 18, price: 149, stock_qty: 70, low_stock_threshold: 20, is_active: true },
  { name: 'Diwali Lights (10m)', barcode: '8901234567902', category: 'Seasonal', hsn_code: '9405', gst_rate: 18, price: 149, stock_qty: 15, low_stock_threshold: 20, is_active: true },
];
